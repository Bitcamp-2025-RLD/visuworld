...
def generate_shader(prompt: str) -> str:
    ...
    response = model.models.generate_content(model="gemini-2.5-pro-exp-03-25", contents=final_prompt)

    return response.text


if __name__ == "__main__":
    user_prompt = input("🧠 What kind of shader should Gemini generate? ")
    ...
    with open("./../public/shader.frag", "w") as f:
        f.write(cleaned_result)
    # close the file
